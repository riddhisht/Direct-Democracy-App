...
const AdminPage = ({navigation})=>{
    ...
    if(loading){
      ...
      return(
          ...
          <Button title='Signout' color='blue' onPress={()=>navigation.replace('AdminLogin')}/>
          <FlatList
          data = {dat}
          renderItem={({ item }) => (
            ...
            onPress={() => navigation.navigate('ViewBill',{data:item,username:username,userId:userId})}>
              <View style={styles.listitem}>
                  ...
                  <Button title='Accept' color="green" onPress={()=>accept(item.key)}/>
                  <Button title='Reject' color="red" onPress={()=>reject(item.key)}/>
