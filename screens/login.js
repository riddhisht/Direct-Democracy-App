  ...
  const login = () => {
    auth()
      ...
      .then(() => {
        ...
        method: 'POST',
        headers: {
          'Authorization':'AAAAbICcrgA:APA91bFua2I_QOMauNhm4yOrlApDcxRouzszKWai6Cj2WKiXGeKm13AwgByTBedIRUaGiiEgOZWJTWswIj5FGw1jHTiyG65lLJhb9xcx2jydM6hXJeRgGTGBsmJSdUm6yr6UL1hXU8qH',
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({
          notification:{
